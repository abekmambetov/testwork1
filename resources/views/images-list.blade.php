...
<html>
    ...
    <div style="padding: 30px">
	    @foreach ($images as $item)
		    <div><img src="/storage/thumb_{{$item['filename']}}" class="rounded float-left mt-2" width="500"></div>
            <div class="textblock">
                <p>{{$item['filename']}} <b>{{$item['created_at']}}</b></p>
                <p><a target="_blank" href="/storage/{{$item['filename']}}">Смотреть оригинал</a></p>
            </div>
